  ...
  return (
    <div className='sticky top-0 w-full py-4 px-5 flex items-center justify-between z-30 bg-main-body/80 dark:bg-main-body-dark/80 backdrop-blur-lg'>
        ...
        <div className='flex items-center justify-center gap-2'>
            ...
            <Link to="/" className='px-5 py-2.5 rounded-full bg-white dark:bg-dark-gray-dark dark:text-text-dark text-sm'>Patient chart</Link>
            <Link to="/" className='px-5 py-2.5 rounded-full bg-white dark:bg-dark-gray-dark dark:text-text-dark text-sm'>Calendar</Link>
            <Link to="/" className='px-5 py-2.5 rounded-full bg-white dark:bg-dark-gray-dark dark:text-text-dark text-sm'>Doctors</Link>
            <Link to="/" className='px-5 py-2.5 rounded-full bg-white dark:bg-dark-gray-dark dark:text-text-dark text-sm'>Messages</Link>
        </div>

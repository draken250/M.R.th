          ...
          <div class="side1 p-4 ml-4 w-2/3  ">
            ...
            <div class="stats flex gap-4">
              ...
              <div class="smallerstats w-1/3 min-h-full flex flex-col gap-4">
                <div class="calories bg-[#dfcdff] p-5 text-2xl rounded-3xl flex-1 flex flex-col items-start justify-center">
                  245
                  <br />
                  calories
                </div>
                <div class="steps  bg-orange-400 p-5 text-2xl rounded-3xl flex-1 flex flex-col items-start justify-center">
                  7,657
                  <br />
                  steps
                </div>
                <div class="workouts  bg-blue-300 p-5 text-2xl rounded-3xl flex-1 flex flex-col items-start justify-center">
                  4,96 km
                  <br />
                  workouts
                </div>

        ...
        <div class="flex px-5 pb-5 bg-main-body w-full h-full flex-1">
          ...
          <main class="flex-1 p-7 bg-white rounded-3xl w-full min-h-full">
            ...
            <div class="flex gap-4 mb-6">
              <a
                href="#"
                className="text-sm font-semibold flex flex-col items-center justify-center px-0 min-w-[70px] gap-2 text-orange-500 hover:text-orange-500"
              >
              ...
              <a
                href="#"
                className="text-sm font-medium flex flex-col items-center justify-center px-0 min-w-[70px] gap-2 text-black/90 hover:text-orange-500"
              >
